...
Big Data is a field fo technology that helps with the extraction, processing and analysis of information that is too large of complex to be dealt with by traditional software.

### The three V's rule

Big data typically has one of the following chracteristics
...
### Azure HDInsight 
- Flexible multi-propose big data platform (PaaS)
