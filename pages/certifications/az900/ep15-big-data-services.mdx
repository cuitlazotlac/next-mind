...
Internet of Things (IoT) is a a network of internet connected devices (IoT Devices) embedded in everyday objects enabling sending and receiving data such as settings and telemetry.
...
- Programmable SDKs for popular languages (C, Java, Python, Node.js)
...
- Secure end-2-end IoT Solutions
    - Azure Sphere certified chips (microcontrollr units - MCUs)
